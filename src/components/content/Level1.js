...
import unifi_artifacts from '../../abis/Unifi.json'
...
class Level1 extends Component {
  ...
  async loadBlockchainData() {
    ...
    const networkData = unifi_artifacts.networks[networkId]
    const contractAddress = networkData.address
    
    if(networkData) {
      const Unifi = web3.eth.Contract(unifi_artifacts.abi, contractAddress)
      this.setState({ Unifi })


      // let teamCount = await Unifi.methods.getTeamCount.call()
